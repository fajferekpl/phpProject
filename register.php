...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if ($result->num_rows > 0) {
            echo "<script>alert('Konto już istnieje.')</script>";
        } else {
        ...
        echo "<script>alert('Hasła są różne.')</script>";
    }
}
?>
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            <p class="login-text">Zarejestruj się</p>
            <div class="input-group">
                <input type="text" placeholder="Login" name="username"  value="<?php echo $username; ?>" required>
            </div>
            <div class="input-group">
            ...
            <p class="login-register-text">Masz już konto? <a href="index.php">Zaloguj się!</a></p>
        </form>
    </div>
</body>
</html>